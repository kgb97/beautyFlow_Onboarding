...
const NailPolishSVG = ({ size = 24, className, style }: SVGProps) => (
  ...
  >
    {/* Bottle body */}
    <rect x="5" y="10" width="14" height="22" rx="4" fill="#818CF8" />
    <rect x="5" y="10" width="14" height="22" rx="4" fill="url(#nailGradient)" opacity="0.8" />
    {/* Bottle cap */}
    <rect x="8" y="2" width="8" height="10" rx="2" fill="#94A3B8" />
    <rect x="9" y="2" width="6" height="8" rx="1.5" fill="#CBD5E1" />
    {/* Polish level */}
    <rect x="7" y="18" width="10" height="12" rx="2" fill="#6366F1" />
    {/* Shine */}

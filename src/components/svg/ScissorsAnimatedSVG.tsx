...
const ScissorsAnimatedSVG = ({ size = 32, className, style }: SVGProps) => (
  ...
  >
    ...
    <circle cx="16" cy="22" r="1.5" fill="#EEF2FF" />
    {/* Handle left */}
    <ellipse cx="8" cy="5" rx="3" ry="5" stroke="#4F46E5" strokeWidth="1.5" fill="none" transform="rotate(-20 8 5)" />
    {/* Handle right */}
    <ellipse cx="24" cy="5" rx="3" ry="5" stroke="#4F46E5" strokeWidth="1.5" fill="none" transform="rotate(20 24 5)" />
    <style>{`
      .scissor-blade-left {
